...
pipeline {
    ...
    stage('SonarQube Inspection') {
        steps {
            withSonarQubeEnv('SonarQube') { 
                ...
                sh """
                mvn sonar:sonar \
                -Dsonar.projectKey=java-web-app-project-ak \
                -Dsonar.host.url=http://35.203.4.45:9000 \
  ...
  post {
    always {
        ...
        slackSend channel: '#alexander-gcp-pipeline-project-alerts', //update and provide your channel name
